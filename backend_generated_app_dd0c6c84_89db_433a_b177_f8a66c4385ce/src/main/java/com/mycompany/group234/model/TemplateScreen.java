...
public class TemplateScreen {
  ...
  private String screenFilePath;
	...
	@JoinColumn(name = "\"TemplateScreenThumbnail\"", referencedColumnName = "\"DocId\"", insertable = false, updatable = false)
	private Document thumbnail;
	
	@Column(name = "\"TemplateScreenThumbnail\"")
	private Long templateScreenThumbnail;
