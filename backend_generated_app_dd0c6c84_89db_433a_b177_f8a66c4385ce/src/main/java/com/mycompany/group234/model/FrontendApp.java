...
@Column(name = "\"SelectedScreenIds\"")
  ...
  private String company_name;
	...
	@OneToOne(cascade = CascadeType.ALL)
	@JoinColumn(name = "\"FrontendAppMenu\"", referencedColumnName = "\"MenuId\"", insertable = false, updatable = false)
	private Menu_Nav menu;
	
	@Column(name = "\"FrontendAppMenu\"")
	private Integer frontendAppMenu;

	@OneToOne(cascade = CascadeType.ALL)
	@JoinColumn(name = "\"FrontendAppHeaderBar\"", referencedColumnName = "\"HeaderId\"", insertable = false, updatable = false)
	private HeaderBar headerBar;
	
	@Column(name = "\"FrontendAppHeaderBar\"")
	private Integer frontendAppHeaderBar;
