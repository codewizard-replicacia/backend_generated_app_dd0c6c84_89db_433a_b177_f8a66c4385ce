...
@Table(name = "\"MenuItem\"", schema =  "\"generated_app\"")
@Data
...
public class MenuItem {
  ...
  @Column(name = "\"MenuItemId\"", nullable = true )
  ...
  private String uRL;
	...
	@JoinColumn(name = "\"MenuItemIcon\"", referencedColumnName = "\"DocId\"", insertable = false, updatable = false)
	private Document icon;
	
	@Column(name = "\"MenuItemIcon\"")
	private Long menuItemIcon;
