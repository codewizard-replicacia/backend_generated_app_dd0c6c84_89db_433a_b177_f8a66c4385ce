...
class ControllerTest {
  ...
  given()
   ...
   given()
            .when()
            .get("/generated_app/Menu_Navs?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/generated_app/Menu_Navs/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/generated_app/MenuItems?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/generated_app/MenuItems/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateAppConfigurationInstance() throws IOException {
    given()
        ...
        .when()
        .post("/generated_app/AppConfigurations")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/generated_app/AppConfigurations?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/generated_app/AppConfigurations/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/generated_app/HeaderBars?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/generated_app/HeaderBars/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  teardown() {
    ...
    jdbcTemplate.execute("DELETE FROM generated_app.Menu_Nav");
    ...
    jdbcTemplate.execute("DELETE FROM generated_app.MenuItem");
    ...
    jdbcTemplate.execute("DELETE FROM generated_app.AppConfiguration");
    jdbcTemplate.execute("DELETE FROM generated_app.FrontendApp");
    jdbcTemplate.execute("DELETE FROM generated_app.HeaderBar");
    jdbcTemplate.execute("DELETE FROM generated_app.TemplateScreen");
     jdbcTemplate.execute("DELETE FROM generated_app.UICompFields");
     jdbcTemplate.execute("DELETE FROM generated_app.Menu_NavItems");
     ...
     jdbcTemplate.execute("DELETE FROM generated_app.HeaderBarFields");
